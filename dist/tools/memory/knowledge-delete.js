...
export function registerKnowledgeDelete(server, adapter) {
    server.tool('knowledge_delete', 'Delete a knowledge item or decision by ID. Requires confirm: true to prevent accidental deletion.', {
...
//# sourceMappingURL=knowledge-delete.js.map