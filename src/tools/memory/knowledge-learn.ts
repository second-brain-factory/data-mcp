...
export function registerKnowledgeLearn(server: McpServer, adapter: DataAdapter): void {
    server.tool('knowledge_learn', 'Store a learning from experience. Restricted to pattern, insight, or lesson types. Use this after completing work to capture what you learned.', {
