...
const RELATION_TYPES = ['supports', 'contradicts', 'derived_from', 'example_of', 'supersedes', 'part_of', 'prerequisite'] as const;
export function registerLinkCreate(server: McpServer, adapter: DataAdapter): void {
